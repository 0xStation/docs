...
An example of how a user can use NFT Account to transact on your application.
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/watch?v=YJizjHkoxd0&embeds_referring_euri=https%3A%2F%2Fsupport.linea.build%2F&feature=emb_imp_woyt&themeRefresh=1"
