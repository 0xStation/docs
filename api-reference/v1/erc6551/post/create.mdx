...
Once you have an Account Group, you can create any number of accounts bound to any NFTs.
...
<ParamField body="accountGroupId" type="string" required>
  The Accounts Group id to create with.
</ParamField>
...
--data-raw '{
    "accountGroupId": "6e4adbcf-ef53-49aa-82c0-2e10ae4b0d84",
    "nft": {
      "chainId": 137,
