---
title: "Claim Page Link"
---

<Info>This feature is only available for NFT collections created on GroupOS</Info>
...
1. Go to the **Tokens** tab in the Dashboard. Select your NFT collection.
...
4. Customize the permissions to claim, entry fees, and terms and conditions.
   <AccordionGroup>
     <Accordion title="Entry Fee">
       Entry Fee is the fee required to claim the wallet. Select one of the
     ...
     <Accordion title="Eligibility">
       Gate to curate who can mint the wallet based on - ERC-20 token ownership
     ...
     <Accordion title="Call-to-actions">
       ...
       they’ve minted the wallet: - View Directory - Go to site - Join Discord
       - Join Whatsapp
     </Accordion>
...
6. Copy the link and share with your members or users.
