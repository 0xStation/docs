---
title: "Get Started with Smart Modal"
sidebarTitle: "Smart Modal"
description: "User authentication with social login and embedded wallet support."
---

[Try it out!](https://wallet.groupos.xyz/demo)

![auth-modal](https://station-images.nyc3.digitaloceanspaces.com/203dd13d-853d-4863-b230-61bfc2276527.png)
...
The suggested way to use the component is as a “login” component. If wagmi does not find a wallet, you should render the component. Otherwise, if wagmi does find an account, you can render the rest of your app. See the following as an example.
