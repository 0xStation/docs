...
Gas Policies enable developers to design and manage gas sponsorship programs.

<Info>Our Gas Policies are currently only compatible with GroupOS's Smart Accounts.</Info>

Gas Policies leverage [Gas Credits by Gas Station](https://github.com/0xStation/gas-credits) to power gas sponsorship. Gas Station is a network that aligns incentives for gas credit issuers (L2s), dApps, and gas consumers to increase the adoption of smart accounts at scale. 
