---
title: "Update an ERC-721 NFT Collection's Metadata"
sidebarTitle: "Update Collection Metadata"
api: "PUT https://groupos.xyz/api/v1/erc721/collectionMetadata"
---
...
Individual metadata can be set when [minting new NFTs](/api-reference/v1/erc721/post/mint) or [editing their metadata](/api-reference/v1/erc721/put/tokenMetadata) directly, which will override the defaults set here.
...
curl --location --request PUT 'https://groupos.xyz/api/v1/erc721/collectionMetadata' \
