---
title: "Mint NFT Accounts"
sidebarTitle: "Mint Accounts"
api: "POST https://groupos.xyz/api/v1/erc6551/mint"
---

### How to mint NFT Accounts

Once you have an Accounts smart contract, you can mint any number of tokens to any address. Each NFT
...
curl --location --request POST 'https://groupos.xyz/api/v1/erc6551/mint' \
