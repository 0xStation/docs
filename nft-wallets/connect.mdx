...
Enable your users to connect and transact on your application with their NFT Wallets.

## Pre-requisite

Your users can transact with NFT Wallets on applications that support signing and transacting with smart contract wallets.  
...
<AccordionGroup>
  ...
  <Accordion title="Networks">
    Connection is established with Mainnet + selected NFT wallet chain.
  </Accordion>
  ...
  <Accordion title="Events">
    ...
    - Wallet switching adjusts WalletConnect session and informs the dApp via `accountsChanged` event
...
3. Select an NFT Wallet to connect. Check if the connected wallet in the application matches that of the Wallet.
