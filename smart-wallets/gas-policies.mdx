...
Gas credits ($GAS) is a transferrable onchain credit that can only be used to pay for gas via a 4337 paymaster. The Gas Credit Paymaster enables any $GAS holder to approve new sponsorships from their balance. 
...
![gas-purchase](https://station-images.nyc3.digitaloceanspaces.com/3a37b605-f1c4-4d74-9efd-12e98489f10c.png)
