...
- **Flexibility**: our infrastructure and developer tooling allows for maximal customizability in each step of the user journey. From proof-of-humanhood and KYC mechanisms to custom branding and FE, we look to power application experiences in the background.
- **Attributability:** we believe that token networks need to be user-centric (members including both people and bots!) with access to data around to understand engagement and activities
