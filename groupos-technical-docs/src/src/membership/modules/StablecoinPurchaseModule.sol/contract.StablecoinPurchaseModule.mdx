...
[Git Source](https://github.com/0xStation/groupos/blob/dbf5849fa48aac03711471c1ce33b8c26f177a2c/src/membership/modules/StablecoinPurchaseModule.sol)
...
|----|----|-----------|
|`_owner`|`address`|The owner of the ModuleFee, an address managed by Station Network|
...
|`stablecoins`|`address[]`|An array of stablecoin addresses to initialize to state on deployment|
...
```solidity
function batchMintTo(address collection, address paymentCoin, address recipient, uint256 quantity) external payable;
```
