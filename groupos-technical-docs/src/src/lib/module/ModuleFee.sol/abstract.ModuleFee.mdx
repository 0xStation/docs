# ModuleFee
[Git Source](https://github.com/0xStation/groupos/blob/dbf5849fa48aac03711471c1ce33b8c26f177a2c/src/lib/module/ModuleFee.sol)
...
ModuleFeeV2 differs from ModuleFee in that it is intended to be inherited by all purchase modules
...
|Name|Type|Description|
|----|----|-----------|
|`paymentTokens`|`address[]`|The token addresses to call, where address(0) represent network token|
