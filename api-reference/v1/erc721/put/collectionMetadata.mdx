...
Individual metadata can be set when [minting new NFTs](/api/v1/erc721/post/mint) or [editing their metadata](/api/v1/erc721/put/tokenMetadata) directly, which will override the defaults set here.
