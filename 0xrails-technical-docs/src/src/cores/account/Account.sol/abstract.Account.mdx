# Account
[Git Source](https://github.com/0xStation/0xrails/blob/491ae339f09853335dba9e897f46862d776d54b5/src/cores/account/Account.sol)

**Inherits:**
[Rails](/src/Rails.sol/abstract.Rails.md), [BaseAccount](/src/cores/account/BaseAccount.sol/abstract.BaseAccount.md), IERC1271, [Validators](/src/validator/Validators.sol/abstract.Validators.md)
