...
Select your method of distribution.

- **NFT collection created on GroupOS**
    <CardGroup cols={2}>
        <Card
...
- **NFT collection created on third-party platform**: You can distribute Accounts like how you would distribute the NFTs e.g. mint page on Zora. Every NFT will come with an Account address.
...
- **Direct transfer**: You can directly transfer tokens into the Accounts from your wallets.
...
- **New Token collections**
    <CardGroup cols={3}>
        <Card
        title="ERC-1155"
        icon="badge"
        iconType="solid"
        href="/tokens/erc1155/new-collection"
        >
        <div style={{ paddingTop: "8px", fontSize: "14px" }}>
        ...
        icon="coin"
        iconType="solid"
        href="/tokens/erc20/new-collection"
        >
        <div style={{ paddingTop: "8px", fontSize: "14px" }}>
        ...
        icon="image"
        iconType="solid"
        href="/tokens/erc721/new-collection"
        >
        <div style={{ paddingTop: "8px", fontSize: "14px" }}>
