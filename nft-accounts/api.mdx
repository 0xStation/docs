---
title: "Integrate Accounts into Your Application"
---

<Info>This feature is only available for NFT collections created on GroupOS</Info>


Automatically mint, update NFT metadata, and batch execute transactions based on offchain events with Account APIs.
...
4. Once you're done with the set up, follow the guide below to distribute with APIs.
