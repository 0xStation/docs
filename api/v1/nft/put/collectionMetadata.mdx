...
api: "PUT https://members.station.express/api/v1/nft/collectionMetadata"
---
...
curl --location --request PUT 'https://members.station.express/api/v1/nft/collectionMetadata' \
